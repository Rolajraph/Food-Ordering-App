  ...
  useEffect(() => {
    const loadHomeData = async () => {
      try {
        ...
        const sorted = [...foodsRes.data.data.foods].sort((a, b) => b.rating - a.rating);
    ...
    <div>
      <section className="home-hero">
        ...
        <div className="home-hero__content">
          ...
          <p>Order from the best local vendors near you — fresh meals, quick delivery, right to your door.</p>
          <div className="home-hero__actions">
            <Link to="/menu" className="home-hero__btn-primary">Order Now</Link>
            <Link to="/register" className="home-hero__btn-secondary">Get Started</Link>
          </div>
        </div>
      </section>
      ...
      <section className="home-section">
        ...
        <div className="home-categories">
          {categories.map((cat) => (
            <Link key={cat._id} to={`/menu?category=${cat._id}`} className="home-category-chip">
              {cat.name}
            </Link>
          ))}
        </div>
      ...
      <div className="home-cta">
        ...
        <Link to="/menu" className="home-hero__btn-primary">Browse Menu</Link>
      </div>
    </div>
  );
};
